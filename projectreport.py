...
org, im2=ip.processImage(im1,'level-set',500,.5,epsilon=.000001)
org, im3=ip.processImage(im2,'level-set',400,.5,epsilon=.000001)
org, im4=ip.processImage(im3,'level-set',5500,.5,epsilon=.000001)
org, im5=ip.processImage(im4,'level-set',1500,.5,epsilon=.000001)
ax[0].set_title("original")
...
# im = im/255
# org, im1=ip.processImage(im,'shock-filter',1000, 0.5)
